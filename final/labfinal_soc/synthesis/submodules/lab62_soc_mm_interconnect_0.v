...
module lab62_soc_mm_interconnect_0 (
	...
	wire   [26:0] run_s1_agent_m0_address;                                                            // run_s1_agent:m0_address -> run_s1_translator:uav_address
	...
	wire  [105:0] run_s1_agent_rf_source_data;                                                        // run_s1_agent:rf_source_data -> run_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] run_s1_agent_rsp_fifo_out_data;                                                     // run_s1_agent_rsp_fifo:out_data -> run_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> run_s1_agent:cp_valid
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> run_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // run_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [15:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> run_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> run_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> run_s1_agent:cp_endofpacket
	...
	wire  [104:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> hex_digits_pio_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> leds_pio_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> key_s1_agent:cp_data
	...
	wire   [26:0] spi0_spi_control_port_agent_m0_address;                                             // spi0_spi_control_port_agent:m0_address -> spi0_spi_control_port_translator:uav_address
	...
	wire  [105:0] spi0_spi_control_port_agent_rf_source_data;                                         // spi0_spi_control_port_agent:rf_source_data -> spi0_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [105:0] spi0_spi_control_port_agent_rsp_fifo_out_data;                                      // spi0_spi_control_port_agent_rsp_fifo:out_data -> spi0_spi_control_port_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> spi0_spi_control_port_agent:cp_data
	...
	wire          run_s1_agent_rp_valid;                                                              // run_s1_agent:rp_valid -> router_008:sink_valid
	wire  [104:0] run_s1_agent_rp_data;                                                               // run_s1_agent:rp_data -> router_008:sink_data
	wire          run_s1_agent_rp_ready;                                                              // router_008:sink_ready -> run_s1_agent:rp_ready
	wire          run_s1_agent_rp_startofpacket;                                                      // run_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          run_s1_agent_rp_endofpacket;                                                        // run_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [104:0] hex_digits_pio_s1_agent_rp_data;                                                    // hex_digits_pio_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [104:0] leds_pio_s1_agent_rp_data;                                                          // leds_pio_s1_agent:rp_data -> router_014:sink_data
	...
	wire  [104:0] key_s1_agent_rp_data;                                                               // key_s1_agent:rp_data -> router_015:sink_data
	...
	wire  [104:0] spi0_spi_control_port_agent_rp_data;                                                // spi0_spi_control_port_agent:rp_data -> router_017:sink_data
	...
	wire          run_s1_agent_rdata_fifo_src_valid;                                                  // run_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] run_s1_agent_rdata_fifo_src_data;                                                   // run_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          run_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_006:in_0_ready -> run_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> run_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> run_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // run_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> run_s1_agent:rdata_fifo_sink_error
