...
HD_PWD='U:/ece437/test0/CORRECTLABS/lab9/lab9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BTPipeExample.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BTPipeExample.tcl -notrace
