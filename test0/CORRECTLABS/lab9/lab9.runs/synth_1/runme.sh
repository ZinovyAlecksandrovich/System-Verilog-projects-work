...
HD_PWD='U:/ece437/test0/CORRECTLABS/lab9/lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BTPipeExample.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BTPipeExample.tcl
