...
HD_PWD='C:/Users/zinovya2/CORRECTLABS/Lab8/Lab8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JTEG_Test_File.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JTEG_Test_File.tcl -notrace
